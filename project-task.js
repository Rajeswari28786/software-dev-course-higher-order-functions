...
*/
const createUppercase = products.map(product =>
...
products.forEach(product => {
  product.salePrice = discount20(product);
});
...
const totalInventoryValue = products.reduce(
  (total, product) => total + (product.inStock ? product.price : 0),
  0
);
...
// ============================================
 ...
 console.log("Uppercased names:", ...createUppercase);
